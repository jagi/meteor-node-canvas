...
copyResized = function (source, dest) {
...
copyGaussian = function (source, dest) {
  ...
  function gauss(x, y) {
    return (1 / (12 * tuning)) * Math.pow(2.718, (x * x + y * y) / (2 *
      tuning * tuning));
  }
...
copyBilinear = function (source, dest) {
  ...
  function getPixelBi(data, x, y) {
    ...
    return int(int(getPixel(data, fx, fy), getPixel(data, fx + 1, fy), x %
        1),
      int(getPixel(data, fx, fy + 1), getPixel(data, fx + 1, fy + 1), x %
        1), y % 1);
  }
...
copyBicubic = function (source, dest) {
  ...
  function bicubic(x, y, p00, p01, p02, p03, p10, p11, p12, p13, p20, p21,
    ...
    var a12 = -.5 * p00 + 1.25 * p01 - p02 + .25 * p03 + .5 * p20 - 1.25 *
      p21 + p22 - .25 * p23;
    var a13 = .25 * p00 - .75 * p01 + .75 * p02 - .25 * p03 - .25 * p20 + .75 *
      p21 - .75 * p22 + .25 * p23;
    var a20 = p01 - 2.5 * p11 + 2 * p21 - .5 * p31;
    var a21 = -.5 * p00 + .5 * p02 + 1.25 * p10 - 1.25 * p12 - p20 + p22 +
      .25 * p30 - .25 * p32;
    var a22 = p00 - 2.5 * p01 + 2 * p02 - .5 * p03 - 2.5 * p10 + 6.25 * p11 -
      5 * p12 + 1.25 * p13 + 2 * p20 - 5 * p21 + 4 * p22 - p23 - .5 * p30 +
      1.25 * p31 - p32 + .25 * p33;
    var a23 = -.5 * p00 + 1.5 * p01 - 1.5 * p02 + .5 * p03 + 1.25 * p10 -
      3.75 * p11 + 3.75 * p12 - 1.25 * p13 - p20 + 3 * p21 - 3 * p22 + p23 +
      .25 * p30 - .75 * p31 + .75 * p32 - .25 * p33;
    var a30 = -.5 * p01 + 1.5 * p11 - 1.5 * p21 + .5 * p31;
    var a31 = .25 * p00 - .25 * p02 - .75 * p10 + .75 * p12 + .75 * p20 - .75 *
      p22 - .25 * p30 + .25 * p32;
    var a32 = -.5 * p00 + 1.25 * p01 - p02 + .25 * p03 + 1.5 * p10 - 3.75 *
      p11 + 3 * p12 - .75 * p13 - 1.5 * p20 + 3.75 * p21 - 3 * p22 + .75 *
      p23 + .5 * p30 - 1.25 * p31 + p32 - .25 * p33;
    var a33 = .25 * p00 - .75 * p01 + .75 * p02 - .25 * p03 - .75 * p10 +
      2.25 * p11 - 2.25 * p12 + .75 * p13 + .75 * p20 - 2.25 * p21 + 2.25 *
      p22 - .75 * p23 - .25 * p30 + .75 * p31 - .75 * p32 + .25 * p33;
